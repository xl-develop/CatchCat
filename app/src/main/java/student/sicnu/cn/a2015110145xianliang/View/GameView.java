package student.sicnu.cn.a2015110145xianliang.View;
...
/**
 * Created by student on 2018/5/3.
 */
...
public class GameView extends SurfaceView implements View.OnTouchListener {
    ...
    private void failure() {
        ...
        dialog.setMessage("你让神经猫逃出精！神！院！！啦");
    ...
    private void  win() {
        ...
        dialog.setMessage("你用" + (steps + 1) + "步捕捉到了神经猫耶！！！");
        dialog.setCancelable(false);
        dialog.setNegativeButton("再玩一次", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                initGame();
